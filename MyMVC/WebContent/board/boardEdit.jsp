...
<div align="center" id="bbs" class="col-md-8 col-md-offset-2">
	...
	<form name="bf" id="bf" role="form" action="boardEditEnd.do"
	...
	<!-- 원본글쓰기mode는 write, 답변글쓰기 mode는 rewrite로 감  -->	 	
 	<table class="table table-bordered">
 		<tr>
 			...
 			<td style="width:80%">
 			<input type="text" name="idx" id="idx" value="${board.idx}" readonly class="form-control">
 			</td>
 		</tr>
 		<tr>
 			<td style="width:20%"><b>제목</b></td>
 			<td style="width:80%">
 			<input type="text" name="subject" id="subject" value="${board.name}" class="form-control">
 			</td>
 		</tr>
 		<tr>
 			<td style="width:20%"><b>글쓴이</b></td>
 			<td style="width:80%">
 			<input type="text" name="name" id="name" value="${board.name}" class="form-control">
 			</td>
 		</tr> 		
 		<tr>
